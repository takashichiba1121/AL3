...
void GameScene::Update() {
	...
	//debugText_->SetPos(50, 87);
	//debugText_->Printf("rotation_:(%f,%f,%f)", worldTransform_.rotation_.x, worldTransform_.rotation_.y, worldTransform_.rotation_.z);
	//debugText_->SetPos(50, 104);
	//debugText_->Printf("scale_:(%f,%f,%f)", worldTransform_.scale_.x, worldTransform_.scale_.y, worldTransform_.scale_.z);
